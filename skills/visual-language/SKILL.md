---
name: lore-visual-language
description: >
  Visual language rules for Lore surfaces. Trigger: Any dashboard styling,
...
1. The dashboard must feel like Lore, not a generic SaaS admin.
